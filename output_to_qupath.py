...
class KongNetToQuPathConverter:
    ...
    def __init__(self, input_dir: str, output_dir: str, color_mapping: Optional[Dict[str, Tuple[int, int, int]]] = None):
        """
    ...
    def convert_annotation_to_geojson_feature(self, annotation, feature_id: str) -> Dict:
        """
    ...
    def convert_db_to_geojson(self, db_path: Path, output_path: Path) -> bool:
        ...
        try:
            ...
            for annotation in annotation_store.values():
                ...
                feature = self.convert_annotation_to_geojson_feature(annotation, feature_id)
            ...
            logger.info(f"Converted {len(geojson_dict['features'])} annotations to {output_path}")
            return True
